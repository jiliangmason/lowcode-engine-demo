...
const productPath = `/custom-materials-jiliangmason@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('custom-materials-jiliangmason', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'custom-materials': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
